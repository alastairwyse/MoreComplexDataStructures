...
{
    /// <summary>
    /// A tree-based implementation of a max heap.
    /// </summary>
    ...
    {
        /// <summary>
        /// Initialises a new instance of the MoreComplexDataStructures.MaxHeap class.
        /// </summary>
        public MaxHeap()
            : base()
        {
        ...
        /// <summary>
        /// Initialises a new instance of the MoreComplexDataStructures.MaxHeap class that contains elements copied from the specified collection.
        /// </summary>
        /// <param name="collection">The collection whose elements are copied to the new MaxHeap.</param>
        ...
        /// <summary>
        /// Returns the maxmimum item in the heap without removing it.
        /// </summary>
